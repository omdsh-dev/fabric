/**
 * Stent HMR end-to-end proof: a real Loader tree (cordis loader, include,
 * hmr and timer plugins) with the Stent service and transformation hooks,
 ...
 *   release and re-register the Stent patch, flipping the transformed
...
describe('stent HMR end-to-end (child processes)', () => {
  it('keeps Stent transformations live through config-only HMR (row lifecycle)', { timeout: 120_000 }, () => {
  ...
  it('keeps Stent transformations live through module-reload HMR (plugin regeneration)', { timeout: 120_000 }, () => {
