...
import { registerFabricTransform } from '../transform/transform.ts'
import { expandPatchStub, orderInstrumentations, type FabricInstrumentationConfig } from '../transform/config.ts'
...
export type { FabricInstrumentationConfig, InstrumentationConfig } from '../transform/config.ts'
...
export type { FabricWireInstrumentation } from './wire.ts'
